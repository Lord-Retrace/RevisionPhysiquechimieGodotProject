...
/** @type {string} */
const CACHE_VERSION = '1762207242|6733715904';
/** @type {string} */
const CACHE_PREFIX = 'Révision Physiqu-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'revisionpc.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["revisionpc.html","revisionpc.js","revisionpc.offline.html","revisionpc.icon.png","revisionpc.apple-touch-icon.png","revisionpc.audio.worklet.js","revisionpc.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["revisionpc.wasm","revisionpc.pck"];
