...
/** @type {string} */
const CACHE_VERSION = '1759782202|1173757691';
/** @type {string} */
const CACHE_PREFIX = 'Révision Physiqu-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Révisionphysiquechimie.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Révisionphysiquechimie.html","Révisionphysiquechimie.js","Révisionphysiquechimie.offline.html","Révisionphysiquechimie.icon.png","Révisionphysiquechimie.apple-touch-icon.png","Révisionphysiquechimie.audio.worklet.js","Révisionphysiquechimie.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Révisionphysiquechimie.wasm","Révisionphysiquechimie.pck"];
